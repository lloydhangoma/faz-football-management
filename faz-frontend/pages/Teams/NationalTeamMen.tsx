...
const NationalTeamMen: React.FC = () => {
  return (
    <div className="w-full">
      ...
      <div className="relative h-[500px] md:h-[600px] overflow-hidden">
        <img 
          ...
          alt="Chipolololo - Men's National Team"
          ...
          <div className="max-w-[1440px] mx-auto px-4 md:px-12 w-full">
            <div className="max-w-2xl">
              ...
              <p className="text-lg md:text-xl text-gray-100 mb-8 leading-relaxed max-w-xl">
                Zambia's Men's National Football Team - Representing our nation with pride and excellence.
              </p>
              <Link
                to="/teams"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-24">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-4 leading-relaxed">
                The Chipolololo (Green Eagles) is Zambia's senior men's national football team. Established to represent the nation's best talent, our team competes in Africa Cup of Nations, World Cup qualifiers, and international friendlies.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                With a rich history of continental achievements, the Chipolololo continues to be a symbol of excellence and national pride in African football.
              </p>
            </div>
...
export default NationalTeamMen;
