          ...
          <div className="max-w-[1440px] mx-auto px-4 md:px-12 w-full">
            <div className="max-w-2xl">
              ...
              <p className="text-lg md:text-xl text-gray-100 mb-8 leading-relaxed max-w-xl">
                Zambia's Under-17 Teams - Building the foundation of football excellence.
              </p>
              <Link
                to="/teams"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-24">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-4 leading-relaxed">
                The U-17 teams compete at the grassroots and developmental level, featuring young athletes aged 15-17. These teams participate in regional championships and continental competitions, serving as a crucial stepping stone in player development.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                Through structured coaching, talent identification programs, and competitive exposure, the U-17 platform ensures that promising young players are given the opportunity to showcase their abilities and progress through the national team ranks.
              </p>
            </div>
